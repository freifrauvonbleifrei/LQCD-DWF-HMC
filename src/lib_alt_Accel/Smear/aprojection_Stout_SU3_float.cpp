...
namespace {
  bool init1 = AProjection<AField<float,ACCEL> >::Factory_params::Register(
...
template<>
const std::string AProjection_Stout_SU3<AField<float,ACCEL> >::class_name
                       = "AProjection_Stout_SU3<AField<float,ACCEL> >";


#include "lib_alt_Accel/Smear/aprojection_Stout_SU3-tmpl.h"

// class instanciation.
template class AProjection_Stout_SU3<AField<float,ACCEL> >;
