...
namespace {
  bool init = ASmear<AField<double,ACCEL> >::Factory_params::Register(
...
template<>
const std::string ASmear_APE<AField<double,ACCEL> >::class_name
                       = "ASmear_APE<AField<double,ACCEL> >";


#include "lib_alt_Accel/Smear/asmear_APE-tmpl.h"

// class instanciation.
template class ASmear_APE<AField<double,ACCEL> >;
