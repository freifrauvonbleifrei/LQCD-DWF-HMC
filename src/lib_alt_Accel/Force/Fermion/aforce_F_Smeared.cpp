...
template<>
const std::string AForce_F_Smeared<AField<double,ACCEL> >::class_name
                            = "AForce_F_Smeared<AField<double,ACCEL> >";


template class AForce_F_Smeared<AField<double,ACCEL> >;
