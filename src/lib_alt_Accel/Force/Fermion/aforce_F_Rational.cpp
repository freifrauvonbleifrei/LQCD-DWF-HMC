...
template<>
const std::string AForce_F_Rational<AField<double,ACCEL> >::class_name
                           = "AForce_F_Rational<AField<double,ACCEL> >";


template class AForce_F_Rational<AField<double,ACCEL> >;
