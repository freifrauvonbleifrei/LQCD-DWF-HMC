/*!
      @file    mult_Wilson_xyz_openacc-inc.h
      @brief
...
//                                    [13 Jun 2019 H.Matsufuru]
      ...
      int isn = nn + iyzt * Nx;
      int isg = ix + iyzt * Nx + idir * Nst_pad;
      ...
      // ic = 0;
     {
      ...
      isg = ix + iy * Nx + izt * Nxy + idir * Nst_pad;
      ...
      isn = ix + nn * Nx + izt * Nxy;
      isg = ix + nn * Nx + izt * Nxy + idir * Nst_pad;
      ...
      isg = ixy + iz * Nxy + it * Nxyz + idir * Nst_pad;
      ...
      isn = ixy + nn * Nxy + it * Nxyz;
      isg = ixy + nn * Nxy + it * Nxyz + idir * Nst_pad;
