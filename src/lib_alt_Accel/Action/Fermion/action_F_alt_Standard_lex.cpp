...
template<>
const std::string Action_F_alt_Standard_lex<AField<double,ACCEL> >::
       class_name = "Action_F_alt_Standard_lex<Afield<double,ACCEL> >";


template class Action_F_alt_Standard_lex<AField<double,ACCEL> >;
