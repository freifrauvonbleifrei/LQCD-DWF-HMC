...
template<>
const std::string Action_F_alt_Ratio_eo<AField<double,ACCEL> >::
       class_name = "Action_F_alt_Ratio_eo<Afield<double,ACCEL> >";


template class Action_F_alt_Ratio_eo<AField<double,ACCEL> >;
