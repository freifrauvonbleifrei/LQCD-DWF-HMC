...
//================================================================
RandomNumbers *RandomNumberManager::factory(const std::string& rng_type_, unsigned long seed)
{
#ifdef USE_FACTORY
  std::string rng_type=rng_type_;
  if (rng_type == "mseries")  {rng_type = "Mseries"; }
  if (rng_type == "mt19937")  {rng_type = "MT19937"; }

  return RandomNumbers::New(rng_type, seed);
