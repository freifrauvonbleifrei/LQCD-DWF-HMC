...
public:
  ...
  void read_state(std::ifstream&);
  void write_state(std::ofstream&);
  void read_state_binary(std::ifstream&);
  void write_state_binary(std::ofstream&);
  void bcast_state();
  void pack_state(void *);
  void unpack_state(const void *);
