...
RandomNumbers_MT19937::RandomNumbers_MT19937(const vector<unsigned long>& key)
  : m_left(1)
{
...
void RandomNumbers_MT19937::init(unsigned long s, const vector<unsigned long>& key)
{
  init(s);
  int i          = 1;
  int j          = 0;
