...
template<>
const std::string AForce_F_Domainwall_5din<AField<double,QXS> >::class_name
                         = "AForce_F_Domainwall_5din<AField<double,QXS> >";


template class AForce_F_Domainwall_5din<AField<double,QXS> >;
