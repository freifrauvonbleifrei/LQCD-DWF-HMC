                                         ...
                                         const Field_G& U)
{
  ...
  vout.detailed(m_vl, "hoge: %s: force_udiv with Field_G\n", class_name.c_str());
                                         ...
                                         const Field_G& U)
{
  ...
  const int Nc = CommonParameters::Nc();
  vout.detailed(m_vl, "hoge: %s: force_udiv with AFIELD\n", class_name.c_str());
...
#pragma omp barrier
  ...
  QXS_Gauge::mult_Gnd(m_vt3_alt, 0, m_vt1_alt, 0, m_vt2_alt, 0);
#pragma omp barrier

  QXS_Gauge::multadd_Gnd(Sigma_mu, 0, m_vt3_alt, 0, iTheta_nu, 0, real_t(1.0));
#pragma omp barrier

  QXS_Gauge::mult_Gdn(m_vt3_alt, 0, iTheta_mu, 0, V_nu, 0);
#pragma omp barrier

  QXS_Gauge::mult_Gdn(m_vt2_alt, 0, m_vt1_alt, 0, m_vt3_alt, 0);
#pragma omp barrier
...
#pragma omp barrier
  ...
  QXS_Gauge::mult_Gdn(m_vt3_alt, 0, V_mu, 0, iTheta_nu, 0);
#pragma omp barrier
...
#pragma omp barrier
  ...
  QXS_Gauge::multadd_Gnd(Sigma_mu, 0, m_vt3_alt, 0, V_nu, 0, real_t(1.0));
#pragma omp barrier

  QXS_Gauge::mult_Gdd(m_vt2_alt, 0, m_vt1_alt, 0, V_mu, 0);
#pragma omp barrier

  QXS_Gauge::mult_Gnn(m_vt3_alt, 0, m_vt2_alt, 0, V_nu, 0);
#pragma omp barrier
...
#pragma omp barrier
  ...
  QXS_Gauge::mult_Gnn(m_vt2_alt, 0, u_nu, 0, m_vt1_alt, 0);
#pragma omp barrier

  m_shift_alt->backward(m_vt1_alt, u_nu, mu);

  QXS_Gauge::mult_Gnd(c, 0, m_vt2_alt, 0, m_vt1_alt, 0);
#pragma omp barrier

  //- lower direction
  m_shift_alt->backward(m_vt2_alt, u_nu, mu);

  QXS_Gauge::mult_Gnn(m_vt1_alt, 0, u_mu, 0, m_vt2_alt, 0);
#pragma omp barrier

  QXS_Gauge::mult_Gdn(m_vt2_alt, 0, u_nu, 0, m_vt1_alt, 0);
#pragma omp barrier
